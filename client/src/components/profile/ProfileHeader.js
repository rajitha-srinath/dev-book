                    ...
                    <div className="card card-body bg-info text-white mb-3">
                        <div className="row">
                            <div className="col-4 col-md-3 m-auto">
                                <img className="rounded-circle" src={profile.user.avatar} alt="avatr" />
                            </div>
                        </div>
                        <div className="text-center">
                            ...
                            <p>
                                ...
                                {isEmpty(profile.social.instargram) ? null : (
                                    <a className="text-white p-2" href={profile.social.instargram}>
