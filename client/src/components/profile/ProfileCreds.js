...
class ProfileCreds extends Component {
    ...
    render() {
        const { education, experince } = this.props;

        const expItems = experince.map(exp => (
        ...
        const eduItems = education.map(edu => (
            <li key={edu._id} className="list-group-item">
                ...
                <p>
                    <strong>Filed of Study:</strong> {edu.fieldofStudy}
                </p>
                <p>
        ...
        return (
            <div className="row">
                <div className="col-md-6">
                    <h3 className="text-center text-info">Experince</h3>
                    {expItems.length > 0 ? (
